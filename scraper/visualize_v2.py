...
def main_test():
    ...
    # for master_product in get_products_with_names(master_products, ["logitech z533"], False):
    #     print(master_product.product_name)
    #     for subp in master_product.products:
    #         print("- ", subp.id)
    #     print("\n")
    visualize_data(False, ["højtaler"], ["O11DEW"], ["kingston a2000 m.2 nvme ssd - 1tb"], False, False)
